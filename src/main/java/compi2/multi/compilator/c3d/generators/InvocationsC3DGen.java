...
public class InvocationsC3DGen {
    ...
    public RetParamsC3D generateCuartetasExp(AdmiMemory admiMemory, 
            ...
            List<JInvocation> invocations, PrimitiveType primType, int instanceRef){
    ...
    public void generateCuartetasAssign(AdmiMemory admiMemory, List<Cuarteta> internalCuartetas, 
            Memory temporals, C3Dpass pass, 
            List<JInvocation> variable, PrimitiveType primType, ExpressionGenerateC3D value, 
            int instanceRef){
        RetJInvC3D invRet = this.generateC3DInvocations(
