...
public class NumberLine extends JPanel
     ...
     */
    public NumberLine(JTextComponent component) {
        this(component, 3);
    }
     ...
     */
    public NumberLine(JTextComponent component, int minimumDisplayDigits) {
...
//				repaint();
    ...
    public void updateColumna(JLabel label){
        int caretPos = component.getCaretPosition();
        int line = findDelimitadorL(component.getText(), caretPos-1, '\n');
        int columna = (caretPos - line) +1 ;
